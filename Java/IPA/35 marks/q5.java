...
class ElectricBoardManager {
    ...
    private Map<String, List<Integer>> boardReadingsMap = new HashMap<>();
...
public class q5 {
    public static void main(String args[]) throws Exception {
        ...
        int numBoards = sc.nextInt();sc.nextLine();
        ...
        for (int i = 0; i < numBoards; i++) {
            ...
            for (int j = 0; j < numReadings; j++) {
                int reading = sc.nextInt();sc.nextLine();
        ...
        String queryBoardId = sc.nextLine();
        ...
        System.out.println("Average Power Consumption for board " + queryBoardId + " from "+startingRange+" to "+endingRange+": " + average);
    }
}